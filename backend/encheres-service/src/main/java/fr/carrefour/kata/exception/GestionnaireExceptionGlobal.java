...
public class GestionnaireExceptionGlobal {
    ...
    public ResponseEntity<ApiEncheresError> handleBadCredentials(
    ...
    public ResponseEntity<ApiEncheresError> handleDisabled(
    ...
    public ResponseEntity<ApiEncheresError> handleLocked(
            LockedException ex) {
        ApiEncheresError error = new ApiEncheresError(
                Instant.now(),
    ...
    public ResponseEntity<ApiEncheresError> handleAuthentication(AuthenticationException ex) {
        ApiEncheresError error = new ApiEncheresError(
                Instant.now(),
                HttpStatus.UNAUTHORIZED.value(),
                "UNAUTHORIZED",
